/**
 * Extends pos_quote_requests / pos_quotes CHECK constraints for printed + emailed
 * (scripts/add-website-quote-workflow-statuses.sql).
 *
 *   npm run db:add-website-quote-workflow-statuses
 */
...
const sqlPath = path.join(__dirname, 'add-website-quote-workflow-statuses.sql');
...
try {
  ...
  console.log('OK — website quote workflow statuses (printed/emailed) applied.');
} catch (e) {
