/**
 * Clears pos_quotes and pos_sent_emails (see clear-quotes-and-sent-emails.sql).
 *
 *   npm run db:clear-quotes-emails
 */
...
const sqlPath = path.join(__dirname, 'clear-quotes-and-sent-emails.sql');
...
await conn.end();
console.log('Done — pos_quotes and pos_sent_emails cleared.');
