          ...
          <div>
            ...
            <p className="text-xs text-blue-700 mt-1">
              ...
              <span className="block mt-1 text-blue-800/90">
                <strong>Connection timeout from Render?</strong> Set API env <code className="text-[10px] bg-blue-100 px-1 rounded">EMAIL_TRANSPORT=resend</code> + <code className="text-[10px] bg-blue-100 px-1 rounded">RESEND_API_KEY</code> (HTTPS, no SMTP). Or use SES/SendGrid/SMTP2GO with port 465 or 587 — Gmail often blocks cloud SMTP.
              </span>
            </p>
          </div>
        </div>
